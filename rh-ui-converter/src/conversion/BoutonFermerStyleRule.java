...
public class BoutonFermerStyleRule extends AConversionRule {
    ...
    protected void doApply(DfmObject dfmObject, CppClass cppClass)  {
        ...
        dfmObject.getProperties().put("Top", Utils.add(dfmObject.getParent().getProperties().get("ClientHeight"), 0 - BUTTON_HEIGHT - MARGIN));
        dfmObject.getProperties().put("Left", Utils.add(dfmObject.getParent().getProperties().get("ClientWidth"), 0 - BUTTON_WIDTH - MARGIN));
